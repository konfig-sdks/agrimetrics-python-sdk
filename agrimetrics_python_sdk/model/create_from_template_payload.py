...
class CreateFromTemplatePayload(
    schemas.DictSchema
):
    """
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["templateId", "title", "description", "exchange", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["templateId", "title", "description", "exchange", ], str]):
