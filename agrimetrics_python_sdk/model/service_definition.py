...
class ServiceDefinition(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["datasetId", "layerName", "service", "WFS", "WCS", "WMS", "WMTS", "OGCApiFeatures", "OGCApiTiles", "temporal", "datastore", "geoserverHostName", "geometryField", "billable", "defaultEPSGCode", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["datasetId", "layerName", "service", "WFS", "WCS", "WMS", "WMTS", "OGCApiFeatures", "OGCApiTiles", "temporal", "datastore", "geoserverHostName", "geometryField", "billable", "defaultEPSGCode", ], str]):
