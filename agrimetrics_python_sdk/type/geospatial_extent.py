...
class RequiredGeospatialExtent(TypedDict):
...
class OptionalGeospatialExtent(TypedDict, total=False):
    pass

class GeospatialExtent(RequiredGeospatialExtent, OptionalGeospatialExtent):
    pass
