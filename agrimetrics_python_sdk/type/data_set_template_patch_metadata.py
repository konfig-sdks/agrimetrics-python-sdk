...
class RequiredDataSetTemplatePatchMetadata(TypedDict):
    pass

class OptionalDataSetTemplatePatchMetadata(TypedDict, total=False):
    description: str
...
class DataSetTemplatePatchMetadata(RequiredDataSetTemplatePatchMetadata, OptionalDataSetTemplatePatchMetadata):
    pass
