...
from agrimetrics_python_sdk.exceptions_base import ApiValueError
from agrimetrics_python_sdk.exceptions import ClientConfigurationError
from agrimetrics_python_sdk.exceptions import InvalidHostConfigurationError
...
conf = agrimetrics_python_sdk.Configuration(
    ...
    def __init__(self, host=None,
        ...
        """Constructor
        """
        self.host = "https://api-test.agrimetrics.co.uk/catalog" if host is None else host
        """Default Base url
        """
        ...
        self.api_key = {}
        if api_key_header:
            self.api_key['apiKeyHeader'] = api_key_header
        if api_key_query:
            self.api_key['apiKeyQuery'] = api_key_query
        if sec0:
            self.api_key['sec0'] = sec0
        if x_user_header:
            self.api_key['xUserHeader'] = x_user_header
        ...
        """Logging Settings
        """
        self.logger = logging.getLogger("agrimetrics_python_sdk")
    ...
    def auth_settings(self):
        ...
        if 'xUserHeader' in self.api_key:
            auth['xUserHeader'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'x-user-id',
