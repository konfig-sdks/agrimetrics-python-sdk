...
class BaseApi(api_client.Api):
    ...
    def _query_collection_by_id_mapped_args(
        self,
        dataset_id: str,
        collection_id: str,
    ...
    async def _aquery_collection_by_id_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1/collections/{collectionId}',
            headers=_headers,
        )
    ...
    def _query_collection_by_id_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class QueryCollectionByIdRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_collection_by_id(
        self,
        dataset_id: str,
        collection_id: str,
        **kwargs,
        ...
        args = self._query_collection_by_id_mapped_args(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        return await self._aquery_collection_by_id_oapg(
    ...
    def query_collection_by_id(
        ...
        return self._query_collection_by_id_oapg(
            path_params=args.path,
        )

class QueryCollectionById(BaseApi):
    ...
    async def aquery_collection_by_id(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_collection_by_id(
            dataset_id=dataset_id,
            collection_id=collection_id,
            **kwargs,
        )
    ...
    def query_collection_by_id(
        ...
        raw_response = self.raw.query_collection_by_id(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        if validate:
