...
class BaseApi(api_client.Api):
    ...
    def _get_single_catalog_entry_mapped_args(
        self,
        data_set_id: str,
    ...
    async def _aget_single_catalog_entry_oapg(
        self,
    ...
    def _get_single_catalog_entry_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetSingleCatalogEntryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_single_catalog_entry(
        self,
        data_set_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_single_catalog_entry_mapped_args(
            data_set_id=data_set_id,
        )
        return await self._aget_single_catalog_entry_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_single_catalog_entry(
        self,
        data_set_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_single_catalog_entry_oapg(
            path_params=args.path,
        )

class GetSingleCatalogEntry(BaseApi):
    ...
    async def aget_single_catalog_entry(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_single_catalog_entry(
            data_set_id=data_set_id,
            **kwargs,
        )
        if validate:
    ...
    def get_single_catalog_entry(
        ...
        raw_response = self.raw.get_single_catalog_entry(
            data_set_id=data_set_id,
        )
        if validate:
            return DataSetPydantic(**raw_response.body)
