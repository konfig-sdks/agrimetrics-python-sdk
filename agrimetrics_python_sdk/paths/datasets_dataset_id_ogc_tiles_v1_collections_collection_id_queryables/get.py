...
class BaseApi(api_client.Api):
    ...
    def _query_collection_queryables_mapped_args(
        self,
        dataset_id: str,
        collection_id: str,
    ...
    async def _aquery_collection_queryables_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1/collections/{collectionId}/queryables',
            headers=_headers,
        )
    ...
    def _query_collection_queryables_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class QueryCollectionQueryablesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_collection_queryables(
        self,
        dataset_id: str,
        collection_id: str,
        **kwargs,
        ...
        args = self._query_collection_queryables_mapped_args(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        return await self._aquery_collection_queryables_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def query_collection_queryables(
        self,
        dataset_id: str,
        collection_id: str,
    ) -> typing.Union[
        ...
        return self._query_collection_queryables_oapg(
            path_params=args.path,
        )

class QueryCollectionQueryables(BaseApi):
    ...
    async def aquery_collection_queryables(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_collection_queryables(
            dataset_id=dataset_id,
            collection_id=collection_id,
            **kwargs,
        )
    ...
    def query_collection_queryables(
        ...
        raw_response = self.raw.query_collection_queryables(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        if validate:
