...
RequestOptionalQueryParams = typing_extensions.TypedDict(
    ...
    {
        'fileUri': typing.Union[FileUriSchema, str, ],
...
request_query_file_uri = api_client.QueryParameter(
    name="fileUri",
    style=api_client.ParameterStyle.FORM,
    schema=FileUriSchema,
    explode=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _remove_file_mapped_args(
        ...
        if file_uri is not None:
            _query_params["fileUri"] = file_uri
    ...
    async def _aremove_file_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/layers/{layerId}/files',
            auth_settings=_auth,
            headers=_headers,
        )
