...
ParamOneSchema = schemas.StrSchema
ParamTwoSchema = schemas.StrSchema
RequestRequiredPathParams = typing_extensions.TypedDict(
    'RequestRequiredPathParams',
    {
        'datasetId': typing.Union[DatasetIdSchema, str, uuid.UUID, ],
        'paramOne': typing.Union[ParamOneSchema, str, ],
        'paramTwo': typing.Union[ParamTwoSchema, str, ],
    }
)
...
request_path_param_one = api_client.PathParameter(
    name="paramOne",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ParamOneSchema,
    required=True,
)
request_path_param_two = api_client.PathParameter(
    name="paramTwo",
    style=api_client.ParameterStyle.SIMPLE,
    schema=ParamTwoSchema,
    required=True,
)
...
class BaseApi(api_client.Api):
    ...
    def _rest_service_query_0_mapped_args(
        self,
        dataset_id: str,
        param_one: str,
        param_two: str,
        ...
        if param_one is not None:
            _path_params["paramOne"] = param_one
        if param_two is not None:
            _path_params["paramTwo"] = param_two
        args.path = _path_params
        return args

    async def _arest_service_query_0_oapg(
        self,
        ...
        **kwargs,
        ...
        for parameter in (
            ...
            request_path_param_one,
            request_path_param_two,
        ):
        ...
        request_before_hook(
            ...
            path_template='/rest/services/{datasetId}/{paramOne}/{paramTwo}',
            headers=_headers,
        )
    ...
    def _rest_service_query_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class RestServiceQuery0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arest_service_query_0(
        self,
        dataset_id: str,
        param_one: str,
        param_two: str,
        **kwargs,
        ...
        args = self._rest_service_query_0_mapped_args(
            dataset_id=dataset_id,
            param_one=param_one,
            param_two=param_two,
        )
        return await self._arest_service_query_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def rest_service_query_0(
        self,
        dataset_id: str,
        param_one: str,
        param_two: str,
        ...
        return self._rest_service_query_0_oapg(
            path_params=args.path,
        )

class RestServiceQuery0(BaseApi):
    ...
    async def arest_service_query_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arest_service_query_0(
            dataset_id=dataset_id,
            param_one=param_one,
            param_two=param_two,
            **kwargs,
    ...
    def rest_service_query_0(
        ...
        raw_response = self.raw.rest_service_query_0(
            dataset_id=dataset_id,
            param_one=param_one,
            param_two=param_two,
        )
