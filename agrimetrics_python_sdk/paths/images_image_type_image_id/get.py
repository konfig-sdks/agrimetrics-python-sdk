...
request_path_image_type = api_client.PathParameter(
    name="imageType",
...
class BaseApi(api_client.Api):
    ...
    def _get_raw_image_mapped_args(
        self,
        image_type: str,
        image_id: str,
    ...
    async def _aget_raw_image_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/images/{imageType}/{imageId}',
            headers=_headers,
        )
...
class GetRawImageRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_raw_image(
        self,
        image_type: str,
        image_id: str,
        thumbnail: typing.Optional[str] = None,
        **kwargs,
        ...
        args = self._get_raw_image_mapped_args(
            image_type=image_type,
            image_id=image_id,
            thumbnail=thumbnail,
        )
        return await self._aget_raw_image_oapg(
    ...
    def get_raw_image(
        ...
        return self._get_raw_image_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class GetRawImage(BaseApi):
    ...
    async def aget_raw_image(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_raw_image(
            image_type=image_type,
            image_id=image_id,
            thumbnail=thumbnail,
            **kwargs,
    ...
    def get_raw_image(
        ...
        raw_response = self.raw.get_raw_image(
            image_type=image_type,
            image_id=image_id,
            thumbnail=thumbnail,
        )
