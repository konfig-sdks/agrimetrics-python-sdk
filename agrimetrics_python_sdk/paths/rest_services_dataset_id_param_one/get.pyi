...
class BaseApi(api_client.Api):
    ...
    def _rest_service_query_mapped_args(
        self,
        dataset_id: str,
        param_one: str,
    ...
    async def _arest_service_query_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/rest/services/{datasetId}/{paramOne}',
            headers=_headers,
        )
...
class RestServiceQueryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def arest_service_query(
        self,
        dataset_id: str,
        param_one: str,
        **kwargs,
        ...
        args = self._rest_service_query_mapped_args(
            dataset_id=dataset_id,
            param_one=param_one,
        )
        return await self._arest_service_query_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def rest_service_query(
        self,
        dataset_id: str,
        param_one: str,
    ) -> typing.Union[
        ...
        return self._rest_service_query_oapg(
            path_params=args.path,
        )

class RestServiceQuery(BaseApi):
    ...
    async def arest_service_query(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.arest_service_query(
            dataset_id=dataset_id,
            param_one=param_one,
            **kwargs,
        )
    ...
    def rest_service_query(
        ...
        raw_response = self.raw.rest_service_query(
            dataset_id=dataset_id,
            param_one=param_one,
        )
        if validate:
