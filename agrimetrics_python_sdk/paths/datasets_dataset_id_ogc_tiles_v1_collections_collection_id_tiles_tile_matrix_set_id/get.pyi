...
class BaseApi(api_client.Api):
    ...
    def _get_tiles_collection_mapped_args(
        self,
        dataset_id: str,
        collection_id: str,
    ...
    async def _aget_tiles_collection_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1/collections/{collectionId}/tiles/{tileMatrixSetId}',
            headers=_headers,
        )
    ...
    def _get_tiles_collection_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetTilesCollectionRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_tiles_collection(
        self,
        dataset_id: str,
        collection_id: str,
        tile_matrix_set_id: str,
        **kwargs,
        ...
        args = self._get_tiles_collection_mapped_args(
            dataset_id=dataset_id,
            collection_id=collection_id,
            tile_matrix_set_id=tile_matrix_set_id,
        )
        return await self._aget_tiles_collection_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_tiles_collection(
        self,
        dataset_id: str,
        collection_id: str,
        tile_matrix_set_id: str,
        ...
        return self._get_tiles_collection_oapg(
            path_params=args.path,
        )

class GetTilesCollection(BaseApi):
    ...
    async def aget_tiles_collection(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_tiles_collection(
            dataset_id=dataset_id,
            collection_id=collection_id,
            tile_matrix_set_id=tile_matrix_set_id,
            **kwargs,
    ...
    def get_tiles_collection(
        ...
        raw_response = self.raw.get_tiles_collection(
            dataset_id=dataset_id,
            collection_id=collection_id,
            tile_matrix_set_id=tile_matrix_set_id,
        )
