...
from agrimetrics_python_sdk.model.data_request_details import DataRequestDetails as DataRequestDetailsSchema
from agrimetrics_python_sdk.model.rest_error import RestError as RestErrorSchema

from agrimetrics_python_sdk.type.data_request_details import DataRequestDetails
...
from agrimetrics_python_sdk.pydantic.data_request_details import DataRequestDetails as DataRequestDetailsPydantic
...
SchemaFor200ResponseBodyApplicationJson = DataRequestDetailsSchema


@dataclass
class ApiResponseFor200(api_client.ApiResponse):
    body: DataRequestDetails
...
class BaseApi(api_client.Api):
    ...
    def _get_requested_data_mapped_args(
        self,
        request_id: str,
    ...
    async def _aget_requested_data_oapg(
        self,
...
class GetRequestedDataRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_requested_data(
        self,
        request_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_requested_data_mapped_args(
            request_id=request_id,
        )
        return await self._aget_requested_data_oapg(
    ...
    def get_requested_data(
        ...
        return self._get_requested_data_oapg(
            path_params=args.path,
        )

class GetRequestedData(BaseApi):
    ...
    async def aget_requested_data(
        ...
        validate: bool = False,
        **kwargs,
    ) -> DataRequestDetailsPydantic:
        raw_response = await self.raw.aget_requested_data(
            request_id=request_id,
            **kwargs,
        )
        if validate:
            return RootModel[DataRequestDetailsPydantic](raw_response.body).root
        return api_client.construct_model_instance(DataRequestDetailsPydantic, raw_response.body)
    ...
    def get_requested_data(
        ...
        raw_response = self.raw.get_requested_data(
            request_id=request_id,
        )
        if validate:
            return RootModel[DataRequestDetailsPydantic](raw_response.body).root
