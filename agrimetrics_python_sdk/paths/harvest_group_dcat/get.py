...
SchemaFor200ResponseBodyTextTurtle = schemas.DictSchema
...
_response_for_200 = api_client.OpenApiResponse(
    ...
    content={
        'text/turtle': api_client.MediaType(
            schema=SchemaFor200ResponseBodyTextTurtle),
    },
)
...
class BaseApi(api_client.Api):
    ...
    def _get_non_spatial_data_for_group_mapped_args(
        self,
        group: GroupCode,
    ...
    async def _aget_non_spatial_data_for_group_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/harvest/{group}/dcat',
            headers=_headers,
        )
    ...
    def _get_non_spatial_data_for_group_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class GetNonSpatialDataForGroupRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_non_spatial_data_for_group(
        self,
        group: GroupCode,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_non_spatial_data_for_group_mapped_args(
            group=group,
        )
        return await self._aget_non_spatial_data_for_group_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_non_spatial_data_for_group(
        self,
        group: GroupCode,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_non_spatial_data_for_group_oapg(
            path_params=args.path,
        )

class GetNonSpatialDataForGroup(BaseApi):
    ...
    async def aget_non_spatial_data_for_group(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_non_spatial_data_for_group(
            group=group,
            **kwargs,
        )
        if validate:
    ...
    def get_non_spatial_data_for_group(
        ...
        raw_response = self.raw.get_non_spatial_data_for_group(
            group=group,
        )
        if validate:
            return Dictionary(**raw_response.body)
