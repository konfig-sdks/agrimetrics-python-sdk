    ...
    async def _aquery_data_0_oapg(
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/wcs',
            headers=_headers,
        )
...
class QueryData0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_data_0(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_data_0_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_data_0_oapg(
    ...
    def query_data_0(
        ...
        return self._query_data_0_oapg(
            path_params=args.path,
        )

class QueryData0(BaseApi):
    ...
    async def aquery_data_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_data_0(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_data_0(
        ...
        raw_response = self.raw.query_data_0(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
