...
class QueryDataRaw(BaseApi):
    ...
    async def aquery_data(
        ...
        **kwargs,
        ...
        args = self._query_data_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_data_oapg(
    ...
    def query_data(
        ...
        return self._query_data_oapg(
            path_params=args.path,
        )

class QueryData(BaseApi):
    ...
    async def aquery_data(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_data(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_data(
        ...
        raw_response = self.raw.query_data(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
