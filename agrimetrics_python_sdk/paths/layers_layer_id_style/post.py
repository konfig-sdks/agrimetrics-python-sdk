...
SchemaFor200ResponseBodyApplicationJson = RestErrorSchema
...
class BaseApi(api_client.Api):
    ...
    def _auto_generate_style_mapped_args(
        self,
        layer_id: str,
        key: str,
    ...
    async def _aauto_generate_style_oapg(
        self,
...
class AutoGenerateStyleRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aauto_generate_style(
        self,
        layer_id: str,
        key: str,
        **kwargs,
        ...
        args = self._auto_generate_style_mapped_args(
            layer_id=layer_id,
            key=key,
        )
        return await self._aauto_generate_style_oapg(
            query_params=args.query,
            path_params=args.path,
            **kwargs,
        )
    
    def auto_generate_style(
        self,
        layer_id: str,
        key: str,
    ) -> typing.Union[
        ...
        return self._auto_generate_style_oapg(
            query_params=args.query,
            path_params=args.path,
        )

class AutoGenerateStyle(BaseApi):
    ...
    async def aauto_generate_style(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aauto_generate_style(
            layer_id=layer_id,
            key=key,
            **kwargs,
        )
        if validate:
            return RestErrorPydantic(**raw_response.body)
        return api_client.construct_model_instance(RestErrorPydantic, raw_response.body)
    ...
    def auto_generate_style(
        ...
        raw_response = self.raw.auto_generate_style(
            layer_id=layer_id,
            key=key,
        )
        if validate:
