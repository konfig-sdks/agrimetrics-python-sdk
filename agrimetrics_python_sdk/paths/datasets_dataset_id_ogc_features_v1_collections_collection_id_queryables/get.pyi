...
class BaseApi(api_client.Api):
    ...
    def _features_queryables_mapped_args(
        self,
        dataset_id: str,
        collection_id: str,
    ...
    async def _afeatures_queryables_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/features/v1/collections/{collectionId}/queryables',
            headers=_headers,
        )
...
class FeaturesQueryablesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afeatures_queryables(
        self,
        dataset_id: str,
        collection_id: str,
        **kwargs,
        ...
        args = self._features_queryables_mapped_args(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        return await self._afeatures_queryables_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def features_queryables(
        self,
        dataset_id: str,
        collection_id: str,
    ) -> typing.Union[
        ...
        return self._features_queryables_oapg(
            path_params=args.path,
        )

class FeaturesQueryables(BaseApi):
    ...
    async def afeatures_queryables(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afeatures_queryables(
            dataset_id=dataset_id,
            collection_id=collection_id,
            **kwargs,
        )
    ...
    def features_queryables(
        ...
        raw_response = self.raw.features_queryables(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        if validate:
