...
class BaseApi(api_client.Api):
    ...
    def _features_query_conformance_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _afeatures_query_conformance_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/features/v1/conformance',
            headers=_headers,
        )
    ...
    def _features_query_conformance_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class FeaturesQueryConformanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afeatures_query_conformance(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._features_query_conformance_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._afeatures_query_conformance_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def features_query_conformance(
        self,
        dataset_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._features_query_conformance_oapg(
            path_params=args.path,
        )

class FeaturesQueryConformance(BaseApi):
    ...
    async def afeatures_query_conformance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afeatures_query_conformance(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def features_query_conformance(
        ...
        raw_response = self.raw.features_query_conformance(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
