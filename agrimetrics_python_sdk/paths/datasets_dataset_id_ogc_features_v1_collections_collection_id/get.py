...
class BaseApi(api_client.Api):
    ...
    def _features_query_ogc_mapped_args(
        self,
        dataset_id: str,
        collection_id: str,
    ...
    async def _afeatures_query_ogc_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/features/v1/collections/{collectionId}',
            headers=_headers,
        )
...
class FeaturesQueryOgcRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afeatures_query_ogc(
        self,
        dataset_id: str,
        collection_id: str,
        **kwargs,
        ...
        args = self._features_query_ogc_mapped_args(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        return await self._afeatures_query_ogc_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def features_query_ogc(
        self,
        dataset_id: str,
        collection_id: str,
    ) -> typing.Union[
        ...
        return self._features_query_ogc_oapg(
            path_params=args.path,
        )

class FeaturesQueryOgc(BaseApi):
    ...
    async def afeatures_query_ogc(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afeatures_query_ogc(
            dataset_id=dataset_id,
            collection_id=collection_id,
            **kwargs,
        )
    ...
    def features_query_ogc(
        ...
        raw_response = self.raw.features_query_ogc(
            dataset_id=dataset_id,
            collection_id=collection_id,
        )
        if validate:
