...
class DeleteLayerRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adelete_layer(
        self,
        layer_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._delete_layer_mapped_args(
            layer_id=layer_id,
        )
        return await self._adelete_layer_oapg(
...
class DeleteLayer(BaseApi):
    ...
    async def adelete_layer(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adelete_layer(
            layer_id=layer_id,
            **kwargs,
        )
    ...
    def delete_layer(
        ...
        raw_response = self.raw.delete_layer(
            layer_id=layer_id,
        )
