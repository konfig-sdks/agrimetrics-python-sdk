...
class BaseApi(api_client.Api):
    ...
    def _features_query_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _afeatures_query_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/features/v1',
            headers=_headers,
        )
...
class FeaturesQueryRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def afeatures_query(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._features_query_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._afeatures_query_oapg(
    ...
    def features_query(
        ...
        return self._features_query_oapg(
            path_params=args.path,
        )

class FeaturesQuery(BaseApi):
    ...
    async def afeatures_query(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.afeatures_query(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def features_query(
        ...
        raw_response = self.raw.features_query(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
