...
class BaseApi(api_client.Api):
    ...
    def _query_collections_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_collections_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1/collections',
            headers=_headers,
        )
...
class QueryCollectionsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_collections(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_collections_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_collections_oapg(
    ...
    def query_collections(
        ...
        return self._query_collections_oapg(
            path_params=args.path,
        )

class QueryCollections(BaseApi):
    ...
    async def aquery_collections(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_collections(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_collections(
        ...
        raw_response = self.raw.query_collections(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
