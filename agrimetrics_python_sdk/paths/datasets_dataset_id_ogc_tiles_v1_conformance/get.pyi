...
class BaseApi(api_client.Api):
    ...
    def _get_conformance_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aget_conformance_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1/conformance',
            headers=_headers,
        )
...
class GetConformanceRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_conformance(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_conformance_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aget_conformance_oapg(
    ...
    def get_conformance(
        ...
        return self._get_conformance_oapg(
            path_params=args.path,
        )

class GetConformance(BaseApi):
    ...
    async def aget_conformance(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_conformance(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def get_conformance(
        ...
        raw_response = self.raw.get_conformance(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
