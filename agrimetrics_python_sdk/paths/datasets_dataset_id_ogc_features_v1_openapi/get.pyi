...
class BaseApi(api_client.Api):
    ...
    def _query_features_openapi_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_features_openapi_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/features/v1/openapi',
            headers=_headers,
        )
    ...
    def _query_features_openapi_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class QueryFeaturesOpenapiRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_features_openapi(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_features_openapi_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_features_openapi_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def query_features_openapi(
        self,
        dataset_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._query_features_openapi_oapg(
            path_params=args.path,
        )

class QueryFeaturesOpenapi(BaseApi):
    ...
    async def aquery_features_openapi(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_features_openapi(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_features_openapi(
        ...
        raw_response = self.raw.query_features_openapi(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
