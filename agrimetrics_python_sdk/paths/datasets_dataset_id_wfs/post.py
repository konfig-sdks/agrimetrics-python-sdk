...
# body param
SchemaForRequestBodyTextXml = schemas.DictSchema
...
class BaseApi(api_client.Api):
    ...
    def _query_data_open_gis_0_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_data_open_gis_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/wfs',
            body=body,
            headers=_headers,
        )
    ...
    def _query_data_open_gis_0_oapg(
        self,
        body: typing.Any = None,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
...
class QueryDataOpenGis0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_data_open_gis_0(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_data_open_gis_0_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_data_open_gis_0_oapg(
            body=args.body,
            path_params=args.path,
            **kwargs,
        )
    
    def query_data_open_gis_0(
        self,
        dataset_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._query_data_open_gis_0_oapg(
            body=args.body,
            path_params=args.path,
        )

class QueryDataOpenGis0(BaseApi):
    ...
    async def aquery_data_open_gis_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_data_open_gis_0(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_data_open_gis_0(
        ...
        raw_response = self.raw.query_data_open_gis_0(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
