...
class BaseApi(api_client.Api):
    ...
    def _query_data_set_wmts_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_data_set_wmts_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/wmts',
            headers=_headers,
        )
...
class QueryDataSetWmtsRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_data_set_wmts(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_data_set_wmts_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_data_set_wmts_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def query_data_set_wmts(
        self,
        dataset_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._query_data_set_wmts_oapg(
            path_params=args.path,
        )

class QueryDataSetWmts(BaseApi):
    ...
    async def aquery_data_set_wmts(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_data_set_wmts(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_data_set_wmts(
        ...
        raw_response = self.raw.query_data_set_wmts(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
