...
class BaseApi(api_client.Api):
    ...
    def _query_tile_matrix_sets_0_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_tile_matrix_sets_0_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1/tileMatrixSets/{tileMatrixSetId}',
            headers=_headers,
        )
    ...
    def _query_tile_matrix_sets_0_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class QueryTileMatrixSets0Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_tile_matrix_sets_0(
        self,
        dataset_id: str,
        tile_matrix_set_id: str,
        **kwargs,
        ...
        args = self._query_tile_matrix_sets_0_mapped_args(
            dataset_id=dataset_id,
            tile_matrix_set_id=tile_matrix_set_id,
        )
        return await self._aquery_tile_matrix_sets_0_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def query_tile_matrix_sets_0(
        self,
        dataset_id: str,
        tile_matrix_set_id: str,
    ) -> typing.Union[
        ...
        return self._query_tile_matrix_sets_0_oapg(
            path_params=args.path,
        )

class QueryTileMatrixSets0(BaseApi):
    ...
    async def aquery_tile_matrix_sets_0(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_tile_matrix_sets_0(
            dataset_id=dataset_id,
            tile_matrix_set_id=tile_matrix_set_id,
            **kwargs,
        )
    ...
    def query_tile_matrix_sets_0(
        ...
        raw_response = self.raw.query_tile_matrix_sets_0(
            dataset_id=dataset_id,
            tile_matrix_set_id=tile_matrix_set_id,
        )
        if validate:
