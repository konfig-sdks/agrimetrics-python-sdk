...
class BaseApi(api_client.Api):
    ...
    def _query_tiles_v1_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_tiles_v1_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/datasets/{datasetId}/ogc/tiles/v1',
            headers=_headers,
        )
...
class QueryTilesV1Raw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_tiles_v1(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_tiles_v1_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_tiles_v1_oapg(
    ...
    def query_tiles_v1(
        ...
        return self._query_tiles_v1_oapg(
            path_params=args.path,
        )

class QueryTilesV1(BaseApi):
    ...
    async def aquery_tiles_v1(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_tiles_v1(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_tiles_v1(
        ...
        raw_response = self.raw.query_tiles_v1(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
