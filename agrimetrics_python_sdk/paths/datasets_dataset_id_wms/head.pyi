...
class BaseApi(api_client.Api):
    ...
    def _query_with_open_gis_mapped_args(
        self,
        dataset_id: str,
    ...
    async def _aquery_with_open_gis_oapg(
        self,
...
class QueryWithOpenGisRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aquery_with_open_gis(
        self,
        dataset_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._query_with_open_gis_mapped_args(
            dataset_id=dataset_id,
        )
        return await self._aquery_with_open_gis_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def query_with_open_gis(
        self,
        dataset_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._query_with_open_gis_oapg(
            path_params=args.path,
        )

class QueryWithOpenGis(BaseApi):
    ...
    async def aquery_with_open_gis(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aquery_with_open_gis(
            dataset_id=dataset_id,
            **kwargs,
        )
        if validate:
    ...
    def query_with_open_gis(
        ...
        raw_response = self.raw.query_with_open_gis(
            dataset_id=dataset_id,
        )
        if validate:
            return RootModel[str](raw_response.body).root
