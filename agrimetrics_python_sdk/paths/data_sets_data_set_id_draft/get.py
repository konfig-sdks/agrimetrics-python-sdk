...
class BaseApi(api_client.Api):
    ...
    def _get_draft_changes_mapped_args(
        self,
        data_set_id: str,
    ...
    async def _aget_draft_changes_oapg(
        self,
...
class GetDraftChangesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def aget_draft_changes(
        self,
        data_set_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._get_draft_changes_mapped_args(
            data_set_id=data_set_id,
        )
        return await self._aget_draft_changes_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def get_draft_changes(
        self,
        data_set_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._get_draft_changes_oapg(
            path_params=args.path,
        )

class GetDraftChanges(BaseApi):
    ...
    async def aget_draft_changes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.aget_draft_changes(
            data_set_id=data_set_id,
            **kwargs,
        )
        if validate:
    ...
    def get_draft_changes(
        ...
        raw_response = self.raw.get_draft_changes(
            data_set_id=data_set_id,
        )
        if validate:
            return DataSetPydantic(**raw_response.body)
