...
class BaseApi(api_client.Api):
    ...
    def _discard_draft_changes_mapped_args(
        self,
        data_set_id: str,
    ...
    async def _adiscard_draft_changes_oapg(
        self,
        ...
        **kwargs,
        ...
        request_before_hook(
            ...
            path_template='/data-sets/{dataSetId}/draft',
            headers=_headers,
        )
    ...
    def _discard_draft_changes_oapg(
        self,
            path_params: typing.Optional[dict] = {},
        skip_deserialization: bool = True,
        timeout: typing.Optional[typing.Union[float, typing.Tuple]] = None,
...
class DiscardDraftChangesRaw(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    async def adiscard_draft_changes(
        self,
        data_set_id: str,
        **kwargs,
    ) -> typing.Union[
        ...
        args = self._discard_draft_changes_mapped_args(
            data_set_id=data_set_id,
        )
        return await self._adiscard_draft_changes_oapg(
            path_params=args.path,
            **kwargs,
        )
    
    def discard_draft_changes(
        self,
        data_set_id: str,
    ) -> typing.Union[
        ApiResponseFor200,
        ...
        return self._discard_draft_changes_oapg(
            path_params=args.path,
        )

class DiscardDraftChanges(BaseApi):
    ...
    async def adiscard_draft_changes(
        ...
        **kwargs,
        ...
        raw_response = await self.raw.adiscard_draft_changes(
            data_set_id=data_set_id,
            **kwargs,
        )
    ...
    def discard_draft_changes(
        ...
        raw_response = self.raw.discard_draft_changes(
            data_set_id=data_set_id,
        )
